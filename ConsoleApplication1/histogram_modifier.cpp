...
int main(int argc, char** argv)
{
    ...
    src = imread("../../histogram_equalization_comparer/comparator_histogram.jpg", IMREAD_GRAYSCALE);
    ...
    int pesohist = cvRound((double)altoHist / numberhist);
